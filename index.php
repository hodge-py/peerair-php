  ...
  <div class='d-flex justify-content-evenly'>
    ...
    <div class="card text-bg-dark mb-3 text-center" >
      <div class="card-header">
        ...
        <label class="btn btn-outline-secondary" for="option1">Monthly</label>

        <input type="radio" class="btn-check" name="options" id="option2" autocomplete="off">
        <label class="btn btn-outline-secondary" for="option2">Yearly</label>
      </div>
      <div class="card-body">
        

        <div class="card-text">
          <div class='display-6'>$2.99/Mo</div>
